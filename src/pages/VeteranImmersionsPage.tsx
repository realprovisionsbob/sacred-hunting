    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
              ...
              <p className="text-xl text-earth-cta font-semibold mt-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="card text-center">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                <div>
                  <h3 className="text-lg font-bold text-earth-cta mb-2">When</h3>
                  <p className="text-gray-900">March 13-16, 2025</p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-earth-cta mb-2">Where</h3>
                  <p className="text-gray-900">Austin, Texas</p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-earth-cta mb-2">Cost</h3>
                  <p className="text-gray-900">Sliding scale depending on need</p>
                </div>
                <div>
                  <h3 className="text-lg font-bold text-earth-cta mb-2">Spots</h3>
                  <p className="text-gray-900">6-8 available</p>
                </div>
              </div>
              
              <div className="bg-earth-brown/20 rounded-lg p-6 mb-8">
                <p className="text-lg font-semibold text-earth-cta mb-2">Important Commitment:</p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="card">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Veteran-Led Ceremonies</h3>
                <p className="text-gray-600">
              ...
              <div className="card">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Warrior Integration</h3>
                <p className="text-gray-600">
              ...
              <div className="card">
                <div className="text-3xl mb-4">🤝</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Brotherhood Circle</h3>
                <p className="text-gray-600">
              ...
              <div className="card">
                <div className="text-3xl mb-4">🌿</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Trauma-Informed Healing</h3>
                <p className="text-gray-600">
              ...
              <div className="card">
                <div className="text-3xl mb-4">🏹</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Purpose-Driven Hunting</h3>
                <p className="text-gray-600">
              ...
              <div className="card">
                <div className="text-3xl mb-4">🎯</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">Skills Translation</h3>
                <p className="text-gray-600">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="card">
              <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">From Service to Sacred Hunt</h3>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="card text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  <h3 className="text-lg font-bold text-earth-cta mb-3">Application Requirements</h3>
                ...
                <div>
                  <h3 className="text-lg font-bold text-earth-cta mb-3">What to Expect</h3>
                  <ul className="text-left text-gray-600 space-y-2">
