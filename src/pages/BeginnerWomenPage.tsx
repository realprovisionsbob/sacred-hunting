          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="card">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Women-Led Instruction</h3>
              ...
              <div className="card">
                <div className="text-3xl mb-4">🌙</div>
                <h3 className="text-xl font-bold text-white mb-3">Sacred Feminine Ceremony</h3>
                <p className="text-gray-300">
              ...
              <div className="card">
                <div className="text-3xl mb-4">🌺</div>
                <h3 className="text-xl font-bold text-white mb-3">Plant Medicine Work</h3>
                <p className="text-gray-300">
              ...
              <div className="card">
                <div className="text-3xl mb-4">👭</div>
                <h3 className="text-xl font-bold text-white mb-3">Sisterhood Circle</h3>
                <p className="text-gray-300">
              ...
              <div className="card">
                <div className="text-3xl mb-4">🦌</div>
                <h3 className="text-xl font-bold text-white mb-3">Ethical Hunting Practices</h3>
                <p className="text-gray-300">
              ...
              <div className="card">
                <div className="text-3xl mb-4">🍲</div>
                <h3 className="text-xl font-bold text-white mb-3">Sacred Feast</h3>
                <p className="text-gray-300">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="card">
                ...
                <h4 className="text-lg font-bold text-white mt-6 mb-3">Technology-Free Zone</h4>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              <blockquote className="card text-center">
                ...
                <footer className="text-earth-tan font-semibold">— Sarah L., Marketing Manager</footer>
              </blockquote>
              ...
              <blockquote className="card text-center">
                ...
                <footer className="text-earth-tan font-semibold">— Maria C., Teacher</footer>
              </blockquote>
